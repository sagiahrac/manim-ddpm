...
class ThreeIdeasIntersectionSlide(Scene, DDPMBaseMixin):
    def construct(self):
        ...
        ddpm_background.move_to(ORIGIN)
        ...
        # Create arrows pointing to DDPM
        arrow_vi = Arrow(
            start=vi_group.get_bottom(),
            end=ddpm_background.get_center() + UP * 0.5,
            color=BLUE,
            stroke_width=4,
        ...
        arrow_elbo = Arrow(
            ...
            end=ddpm_background.get_center() + LEFT * 0.5 + DOWN * 0.3,
            color=GREEN,
            stroke_width=4,
            max_tip_length_to_length_ratio=0.1
        )
        ...
        arrow_score = Arrow(
            ...
            end=ddpm_background.get_center() + RIGHT * 0.5 + DOWN * 0.3,
            color=RED,
            stroke_width=4,
            max_tip_length_to_length_ratio=0.1
        )
