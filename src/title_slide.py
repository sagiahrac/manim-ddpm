...
class TitleSlide(Scene, DDPMBaseMixin):
    def construct(self):
        ...
        title = Text("Denoising Diffusion", 
                    font="TeX Gyre Termes", font_size=52, color="#87CEEB", weight=BOLD)
        title.move_to(UP * 1.5)
        
        subtitle = Text("Probabilistic Models", 
                       font="TeX Gyre Termes", font_size=52, color="#87CEEB", weight=BOLD)
        ...
        authors = Text("Ho, Jain, Abbeel (2020)", 
                      font="TeX Gyre Termes", font_size=28, color="#B0B0B0")
        authors.next_to(underline, DOWN, buff=0.8)
        
        course = Text("Stochastic Processes in Modern ML", 
                     font="TeX Gyre Termes", font_size=22, color="#808080")
        course.next_to(authors, DOWN, buff=0.4)
        
        presenter = Text("Sagi Ahrac", 
                        font="TeX Gyre Termes", font_size=22, color="#808080")
